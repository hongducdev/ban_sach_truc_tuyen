...
const ProductPage = () => {
   ...
   useEffect(() => {
      ...
      axios
         .get(
            `https://ban-sach-ebook-co.onrender.com/api/products/${productID}`
         )
         .then((res) => {
            setProduct(res.data)
   ...
   const handleAddCart = (id) => {
      fetch(`https://ban-sach-ebook-co.onrender.com/api/carts/${productID}`, {
         method: 'POST',
         headers: {
               ...
               <div className='container my-10 flex'>
                  <div className='inline-flex gap-5 w-2/3 flex-1'>
                     <div className='inline-flex flex-col gap-2'>
                        {product.images &&
                           convertToArray(product.images).map(
                              (image, index) => (
                  ...
                  <div className='w-1/3'>
                     ...
                     <div className='flex items-center gap-2 my-5'>
                        ...
                        <div className='flex items-center gap-2'>
                           ...
                           <p className=''>
                              <span className=''>{quantity}</span> sản phẩm có
                              sẵn
                           </p>
                        </div>
                     </div>
