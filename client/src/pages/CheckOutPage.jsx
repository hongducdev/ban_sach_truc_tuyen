...
const CheckOutPage = () => {
   ...
   const handleOrder = (values) => {
      ...
      if (onlinePayment) {
         fetch(
            'https://ban-sach-ebook-co.onrender.com/api/webhook/register-webhook',
            {
               method: 'POST',
               headers: {
                  'Content-Type': 'application/json',
                           ...
                           <>
                              ...
                              <div className='my-3 flex flex-col gap-y-2'>
                                 ...
                                 <p className=''>
                                    ...
                                    <br />
                                    (Lưu ý: Chuyển khoản đúng nội dung và thanh
                                    toán trước khi ấn nút "
                                    <strong>Đặt hàng</strong>" để đơn hàng được
                                    xử lý nhanh nhất, chuyển khoản sai nội dung
                                    sẽ không được xử lý)
                                 </p>
                              </div>
                           </>
